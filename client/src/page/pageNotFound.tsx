...
const NotFound: React.FC = () => {
  return (
    <div className="bg-[#f6f8f6] dark:bg-[#102213] font-display text-slate-900 dark:text-white min-h-screen w-full flex flex-col relative overflow-hidden">
      ...
      <footer className="py-8 text-center text-slate-400 dark:text-slate-600 text-[10px] font-black uppercase tracking-[0.2em]">
        © 2026 EBA Store. Digital Inventory Systems.
      </footer>
    </div>
  );
};
